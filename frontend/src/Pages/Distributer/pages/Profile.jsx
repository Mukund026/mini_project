...
const Profile = () => {
  ...
  useEffect(() => {
    const savedProfile =
      JSON.parse(localStorage.getItem("distributerProfile")) || {};
    setName(savedProfile.name || "");
    setlocation(savedProfile.location || "");
    setPhone(savedProfile.phone || "");
    setPreview(savedProfile.preview || null);
    setDistributorId(localStorage.getItem("userId") || "");
  }, []);
  ...
  const saveProfile = () => {
    ...
    localStorage.setItem("distributerProfile", JSON.stringify(profileData));
