...
const Profile = () => {
  ...
  const [consumereId, setConsumereId] = useState("");
  ...
  useEffect(() => {
    const savedProfile =
      JSON.parse(localStorage.getItem("consumerProfile")) || {};
    setName(savedProfile.name || "");
    setlocation(savedProfile.location || "");
    setPhone(savedProfile.phone || "");
    setPreview(savedProfile.preview || null);
    setConsumereId(localStorage.getItem("userId") || "");
  }, []);
  ...
  const saveProfile = () => {
    ...
    localStorage.setItem("consumerProfile", JSON.stringify(profileData));
