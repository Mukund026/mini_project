...
import OrderTraceModal from "./OrderTraceModal";
import "./myorders.css";
...
const MyOrders = () => {
  ...
  const clearAllOrders = () => {
    localStorage.setItem("consumerOrders", JSON.stringify([]));
    setOrders([]);
  ...
  const closeTraceModal = () => {
    setTraceModal({ show: false, productId: null });
  };
  ...
  return (
    <div className="my-orders">
          ...
          {orders.map((order, index) => (
            <tr key={order._id || index}>
              ...
              <td>
                <button
                  onClick={() =>
                    setTraceModal({ productId: order.product._id, show: true })
                  }
                >
                  Trace
                </button>
      ...
      {traceModal.show && (
        <OrderTraceModal
          productId={traceModal.productId}
